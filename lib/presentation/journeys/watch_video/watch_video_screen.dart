                  ...
                  child: Column(
                    children: [
                      for (int i = 0; i < _videos.length; i++)
                        Container(
                          height: 60.h as double?,
                          padding:
                              EdgeInsets.symmetric(vertical: Sizes.dimen_8.h as double),
                          child: Row(
                            children: <Widget>[
                              GestureDetector(
                                onTap: () {
                                ...
                                child: CachedNetworkImage(
                                  width: Sizes.dimen_200.w as double?,
                              ...
                              Expanded(
                                child: Padding(
                                  padding:
                                      EdgeInsets.symmetric(horizontal: 8.w as double),
                                  child: Text(
                                    _videos[i].title!,
                                    style:
