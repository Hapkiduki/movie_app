    ...
    return GestureDetector(
      ...
      child: Padding(
        padding: EdgeInsets.symmetric(
          horizontal: Sizes.dimen_16.w as double,
          vertical: Sizes.dimen_2.h as double,
        ),
        child: Row(
          children: [
            Padding(
              padding: EdgeInsets.all(Sizes.dimen_8.w as double),
              child: ClipRRect(
                borderRadius: BorderRadius.circular(Sizes.dimen_4.w as double),
